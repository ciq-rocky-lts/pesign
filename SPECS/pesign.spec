...
Patch99999: 0031-Adding-Rocky-Certs.patch
...
%dir %attr(0775,pesign,pesign) %{_sysconfdir}/pki/pesign-r-test/
%config(noreplace) %attr(0664,pesign,pesign) %{_sysconfdir}/pki/pesign-rh-test/*
%config(noreplace) %attr(0664,pesign,pesign) %{_sysconfdir}/pki/pesign-r-test/*
%{_libexecdir}/pesign/pesign-authorize
...
%changelog
* Wed Apr 05 2023 Sherif Nagy <sherif@rockylinux.org> - 0.112-27
- Adding local signing cert

* Wed Apr 05 2023 Louis Abel <label@rockylinux.org> - 0.112-27
